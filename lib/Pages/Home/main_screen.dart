...
import 'package:dsvv/Pages/international_collaboration.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  final List internationalmew = [
    'assets/images/main_campus.jpg',
    'assets/images/main_campus.jpg',
    'assets/images/main_campus.jpg',
    'assets/images/main_campus.jpg',
    'assets/images/main_campus.jpg',
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          itemCount: internationalmew.length,
                          itemBuilder: (context, index) {
                            return InternationCollaboration(
                              internationalCollaboration:
                                  internationalmew[index],
                            );
                          }),
                    ),
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          width: MediaQuery.of(context).size.width,
                          decoration: const BoxDecoration(
                            color: Color.fromARGB(1000, 90, 120, 139),
                          ),
                          child: Row(
                            children: [
                              const Padding(
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(
                                        'assets/images/dsvv_logo_main_page.png'),
                                  ),
                                ),
                              ),
                              const SizedBox(width: 8),
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            color: Color.fromARGB(98, 7, 107, 114),
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              const Text(
                                "~ Kulpita Pt. Shriram Sharma Acharya",
                                style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w700,
                                    fontFamily: 'Futura'),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Text(
                                      "Dev Sanskiriti Vishwavidhyalaya",
                                      style: TextStyle(
                                          fontSize: 15,
                                          fontFamily: 'Futura',
                                          fontWeight: FontWeight.w600),
                                    ...
                                    const Text.rich(
                                      TextSpan(
                                        text: 'Admission (Regular Courses): ',
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 13,
                                            fontFamily: 'Futura'),
                                    ...
                                    const Text.rich(
                                      TextSpan(
                                        ...
                                        children: <InlineSpan>[
                                          TextSpan(
                                              text:
                                                  '2002-2022 Dev Sanskriti Vishwavidyalaya All Rights Reserved.',
                                              style: TextStyle(
                                                  fontWeight: FontWeight.w400))
                                        ],
                                      ),
