var coursesData = {
  ...
  'B.Sc. (Hons.) Yogic Science': {
    "title": "B.Sc. (Hons.) Yogic Science",
    "eligibility":
  ...
  'B.Sc. (Hons.) Environmental Science': {
    "title": "B.Sc. (Hons.) Environmental Science",
    "eligibility":
  ...
  //MSc.
  'M.Sc. Applied Medicinal And Aromatic Plant Sciences': {
    "title": "M.Sc. Applied Medicinal And Aromatic Plant Sciences",
    "eligibility":
  ...
  'M.Sc. Human Consciousness and Yogic Science': {
    "title": "M.Sc. Human Consciousness and Yogic Science",
    "eligibility":
        "Bachelor’s degree with minimum 50% marks from any recognized university following 10+2+3 course pattern. (Arts Side Candidate would be eligible for M.A. Course while Science Side Candidate would be eligible for M.Sc. Course)",
    "admission":
        "On the basis of Written Entrance Examination and Personal interview",
...
final List<dynamic> courses = [
  ["BCA", "BBA", "BA", "B.Sc.", "B.Voc", "B.Ed", "BRS"],
  ['MA', 'M.Sc.', 'MCA', 'MBA'],
  ['Diploma'],
  ['PG Diploma'],
  ['Certificate']
