...
import 'package:dsvv/Pages/Academics/IQC.dart';
import 'package:dsvv/Pages/Academics/Rsearch.dart';
...
import 'package:dsvv/Pages/Academics/library.dart';
import 'package:dsvv/Pages/Academics/schools.dart';
  ...
  Widget _academicHighlightCard(title, navigation) {
    return GestureDetector(
      onTap: () {
        ...
        }else if (navigation == "IQAC") {
          Get.to(
            () => const IQAC(),
            transition: Transition.zoom,
            duration: const Duration(milliseconds: 400),
          );
          }else if (navigation == "ResearchPapers") {
          Get.to(
            () => const ResearchPapers(),
            transition: Transition.zoom,
            duration: const Duration(milliseconds: 400),
          );
          }else if (navigation == "School") {
          Get.to(
            () => const School(),
            transition: Transition.zoom,
            duration: const Duration(milliseconds: 400),
          );
          }else if (navigation == "Calender") {
          Get.to(
            () => const Calender(),
            transition: Transition.zoom,
            duration: const Duration(milliseconds: 400),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Academics Highlight"),
        centerTitle: false,
        actions: <Widget>[
          IconButton(
            onPressed: () {},
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          _academicHighlightCard("Library", "Library"),
                          const SizedBox(width: 10.0),
                          const Padding(
                            padding: EdgeInsets.all(20.0),
                          ),
                          _academicHighlightCard("Academic Calendar", "Calender"),
                          const SizedBox(width: 10.0),
                          const Padding(
                            padding: EdgeInsets.all(20.0),
                          ),
                          _academicHighlightCard(
                              "Schools, Faculties & Departments", "School"),
                          const SizedBox(width: 10.0),
                          const Padding(
                            padding: EdgeInsets.all(20.0),
                          ),
                          ...
                          _academicHighlightCard("Research @ DSVV", "ResearchPapers"),
                          const SizedBox(width: 10.0),
                          const Padding(
                            padding: EdgeInsets.all(20.0),
                          ),
                          ...
                          _academicHighlightCard("Internal Quality Assurance Cell", "IQAC"),
                          const SizedBox(width: 10.0),
                          const Padding(
                            padding: EdgeInsets.all(20.0),
                          ),
